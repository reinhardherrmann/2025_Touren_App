<div>
    <flux:modal name="create-address" class="md:w-96">
        <div class="space-y-6">
            ...
            <!--<flux:textarea wire:model="remark"label="Bemerkung" placeholder="Tragen Sie Ihre Anmerkungen ein" />-->
            <div class="flex">
                <flux:spacer />

                <flux:button wire:click="saveAddress" type="submit" variant="primary">Speichern</flux:button>
            </div>
        </div>
    </flux:modal>
</div>
